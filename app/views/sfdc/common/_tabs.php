...
$tableId = $tabConfig['tableId'] ?? 'sfdc-table-tab';
$dashboardId = $tabConfig['dashboardId'] ?? 'sfdc-dashboard-tab';
?>

<ul class="nav nav-tabs mb-3" id="sfdcViewTabs" role="tablist">
...
<script>
    (function() {
        const tabs = document.querySelectorAll('#sfdcViewTabs button[data-bs-toggle="tab"]');
