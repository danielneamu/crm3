(function (window, document) {
    ...
    function buildInput(field, value, options) {
        ...
        if (field === 'Revised_AOV' && options.placeholders && options.placeholders.aov) {
            input.placeholder = options.placeholders.aov;
        }

        if (field === 'Revised_NPV' && options.placeholders && options.placeholders.npv) {
            input.placeholder = options.placeholders.npv;
        }
    ...
    function saveCell(cell, config, newValue, originalValue) {
        ...
        return fetch(config.endpoint, {
            ...
            .then(function (result) {
                ...
                document.dispatchEvent(new CustomEvent('sfdcInlineEditSaved', {
                    detail: {
                        id: rowId,
                        field: field,
                        value: displayValue,
            ...
            .catch(function (error) {
                ...
                document.dispatchEvent(new CustomEvent('sfdcInlineEditError', {
                    detail: {
                        id: rowId,
                        field: field,
                        value: fallbackValue,
    ...
    function activateEditableCell(cell, config) {
        ...
        const placeholders = {
            aov: cell.dataset.placeholderAov || '',
            npv: cell.dataset.placeholderNpv || ''
        };
