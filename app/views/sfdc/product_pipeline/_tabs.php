...
$tableId = $tabConfig['tableId'] ?? 'product-pipeline-table-tab';
$dashboardId = $tabConfig['dashboardId'] ?? 'product-pipeline-dashboard-tab';
?>

<ul class="nav nav-tabs mb-3" id="productPipelineViewTabs" role="tablist">
...
<script>
    (function() {
        const tabs = document.querySelectorAll('#productPipelineViewTabs button[data-bs-toggle="tab"]');
